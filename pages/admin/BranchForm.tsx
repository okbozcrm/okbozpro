...
const BranchForm: React.FC = () => {
  ...
  const handleNewPlaceSelected = (newPos: { lat: number; lng: number }) => {
    ...
    // We do NOT fetch address here because Autocomplete already provided the address string via onAddressSelect
  };
  ...
  const handleGetAddress = () => {
    ...
    try {
      ...
      geocoder.geocode({ location }, (results: any, status: any) => {
        ...
        } else if (status === 'REQUEST_DENIED' || status === 'ERROR' || status === 'INVALID_REQUEST' || String(status).includes("not activated")) {
