  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Payroll Centre</h2>
          <p className="text-gray-500">Analytics, salaries, and disbursement management</p>
        </div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
                      <div>
                          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Estimated Payout</p>
                  ...
                  <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
                      <div>
                          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Total Incentives</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                      <h3 className="font-bold text-gray-800 mb-6 flex items-center gap-2">
                          <PieChartIcon className="w-5 h-5 text-indigo-500" /> Dept Breakdown
                      </h3>
                      <div className="h-64">
                          <ResponsiveContainer width="100%" height="100%">
                              <PieChart>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-slate-900 text-white p-6 rounded-xl shadow-lg relative overflow-hidden group cursor-pointer" onClick={() => setActiveTab('Salary')}>
                      <h4 className="text-xl font-bold mb-2">Monthly Ledger</h4>
                      <p className="text-slate-400 text-sm mb-4">View and adjust monthly salary payouts.</p>
                  ...
                  <div className="bg-emerald-600 text-white p-6 rounded-xl shadow-lg relative overflow-hidden group cursor-pointer" onClick={() => setActiveTab('Advances')}>
                      ...
                      <p className="text-emerald-100 text-sm mb-4">Manage pending salary advance requests.</p>
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm group">
                      <h4 className="text-xl font-bold text-gray-800 mb-2">Payroll Config</h4>
                      <p className="text-gray-500 text-sm mb-4">Configure CTC and payout cycles.</p>
             ...
             <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                <div className="flex flex-wrap gap-3 w-full md:w-auto flex-1">
                    <div className="relative min-w-[200px] flex-1">
                        ...
                        <input type="text" placeholder="Search staff..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white" />
                    </div>
        ...
        <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
                <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-200">
                    <tr>
                        <th className="px-6 py-4 w-64">Staff</th>
                            ...
                            <tr key={emp.id} className="hover:bg-gray-50/50 transition-colors">
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div><div className="font-semibold text-gray-900">{emp.name}</div><div className="text-xs text-emerald-600">{emp.role}</div></div>
                                    </div>
                                </td>
                                ...
                                <td className="px-4 py-4 text-orange-600">-₹{data.advanceDeduction}</td>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden min-h-[500px] animate-in fade-in slide-in-from-right-4">
          <div className="p-4 border-b border-gray-100 bg-gray-50 font-bold text-gray-800">Pending Advance Requests</div>
          <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
      ...
      {activeTab === 'History' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden animate-in fade-in slide-in-from-right-4">
            <div className="p-6 border-b border-gray-100 bg-gray-50 font-bold text-gray-800">Payroll Archives</div>
            <div className="overflow-x-auto">
