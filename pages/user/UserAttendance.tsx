...
import { 
  ...
  MapPin, Clock, Download, X, Activity, Plane, Save, ChevronDown, 
  CalendarDays, Users, MapPinned
} from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-4 w-full md:w-auto">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="text-3xl font-black text-gray-900 tracking-tight">Attendance Dashboard</h2>
                    <p className="text-sm text-gray-500 font-medium tracking-wide">Daily workforce statistics and presence</p>
                </div>
            </div>
        ...
        <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/20">
            <div className="flex items-center gap-3">
                ...
                <h3 className="font-black text-gray-900 uppercase text-sm tracking-[0.2em]">
                    {viewMode === 'Calendar' ? `Ledger: ${selectedEmployee?.name || 'Staff'}` : `Detailed Daily Logs`}
                </h3>
            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-[3rem] shadow-[0_32px_128px_-16px_rgba(0,0,0,0.2)] w-full max-w-md border border-gray-100 animate-in zoom-in duration-200 overflow-hidden">
                ...
                <div className="p-8 space-y-8">
                    <div>
                        <label className="block text-[11px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4">Select Status</label>
                        <div className="relative">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            <label className="block text-[11px] font-black text-gray-400 uppercase tracking-[0.3em] mb-3">In Time</label>
                            <input value={editForm.checkIn} onChange={e => setEditForm({...editForm, checkIn: e.target.value})} placeholder="09:00 AM" className="w-full p-5 bg-gray-50 border-2 border-gray-100 rounded-[1.8rem] font-black text-gray-800 text-center uppercase tracking-widest outline-none focus:border-emerald-500/50 transition-all shadow-inner" />
                        </div>
                        <div>
                            <label className="block text-[11px] font-black text-gray-400 uppercase tracking-[0.3em] mb-3">Out Time</label>
                            <input value={editForm.checkOut} onChange={e => setEditForm({...editForm, checkOut: e.target.value})} placeholder="06:00 PM" className="w-full p-5 bg-gray-50 border-2 border-gray-100 rounded-[1.8rem] font-black text-gray-800 text-center uppercase tracking-widest outline-none focus:border-emerald-500/50 transition-all shadow-inner" />
                        </div>
                    </div>
                </div>
